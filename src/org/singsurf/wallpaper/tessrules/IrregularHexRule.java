...
public abstract class IrregularHexRule extends TessRule {
    ...
    public static TessRule p2hex = new IrregularHexRule("P2A",
...
//            switch( ((a+b)%3+3)%3 )
		...
		//	this.drawSimpleEdge(O, O.add(V));
			this.drawSimpleEdge(O, Vec.linComb(3, O, -1, U,-1,V,3));
			this.drawSimpleEdge(O, Vec.linComb(3, O, 2, U,-1,V,3));
			this.drawSimpleEdge(O, Vec.linComb(3, O, -1, U,2,V,3));
			if(det>0)
				this.drawSimpleEdge(O.add(U), Vec.linComb(3, O, -1, U,2,V,3));
			else
				this.drawSimpleEdge(O, Vec.linComb(3, O, 2, U,2,V,3));

			//this.drawSimpleEdge(O.add(U), Vec.linComb(1, O, 1, U,2,V));
		}
